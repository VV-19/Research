...
<div class="layui-side layui-bg-black">
  ...
  <div class="layui-body">
    <!-- 内容主体区域 -->
	<div style="padding-left:5px;padding-top:5px;margin:5px">
		<form
			action="${pageContext.request.contextPath }/FindReportAction_findReportByTime"
			method="post">
			<h2>查询科研项目</h2>
			<table>
				<tr>
					<td>学年：</td>
					<td><input class="layui-input" type="text" name="year"
				...
				<tr>
					...
					<td style="padding-left:10px"><button  class="layui-btn" type="submit" >查询</button>
					<td>
				</tr>
			</table>
		</form>
		...
		<tr>
			...
			<td width="105">教师工号</td>
			<td width="105">教师姓名</td>
			...
			<form
				...
				<table>
					<tr>
						...
						<td><button  class="layui-btn" type="submit">详细</button></td>
					</tr>
				</table>
			</form>
		</s:iterator>
