...
<div class="layui-side layui-bg-black">
  ...
  <div class="layui-body" style="padding-left:5px;padding-top:5px">
    <!-- 内容主体区域 -->
		<form
			action="pageAction.request.actionPath/FindReportAction_findReport"
			method="post">
			<table>
				<tr>
					<td>查询科研项目：</td>
					<td><input class="layui-input" type="text" name="res_id" placeholder="项目编号或项目名"></td>
					<td style="padding-left:10px"><button  class="layui-btn" type="submit" name="find">查询</button>
					<td>
				</tr>
			</table>
		</form>
	...
	<div>
		<s:iterator value="researchList">
			<form
				action="${pageContext.request.contextPath}/FindReportAction_reportContent"
