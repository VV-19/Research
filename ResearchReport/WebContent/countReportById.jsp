...
<div class="layui-side layui-bg-black">
  ...
  <div class="layui-body">
	...
	<div  style="padding-left:5px;padding-top:5px;font-size:18px">
			...
			<form
				action="${pageContext.request.contextPath }/FindReportAction_countReportById"
				method="post">
				<table>
				<tr>
					<td>学年：</td>
					...
					<td><select name="semester" class="layui-input">
							<option value="all"
					...
					<td style="padding-left:10px;"><button class="layui-btn layui-btn-sm" type="submit">查询</button></td>
				</tr>
		</table>
		</form>
		...
		<div>
			<form
				action="${pageContext.request.contextPath}/FindReportAction_countXlsById"
				method="post">
				<table>
					<tr>
					<td>报表名:</td>
					<td style="padding-left:10px;"> <input class="layui-input" style="width:200px" type="text" name="file_name" placeholder="请输入报表名"
					required="required">
					</td>
